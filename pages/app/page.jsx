        ...
        <div className="relative z-10 text-center px-4 max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              className="bg-emerald-600 hover:bg-emerald-500 text-white font-semibold px-8 py-4 rounded-full shadow-lg transition-all transform hover:scale-105 text-center flex items-center justify-center gap-2"
            >
                ...
                <div className="flex sm:justify-end">
                  {item.is_available ? (
                    <a
                      ...
                      className="w-full sm:w-auto bg-neutral-800 hover:bg-emerald-600 hover:text-white text-neutral-300 text-sm font-medium px-4 py-2.5 rounded-xl transition-all text-center flex items-center justify-center gap-1.5 group"
                    >
                      <span>Ordina</span>
